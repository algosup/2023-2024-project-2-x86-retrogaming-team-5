...
|------------------------------------------|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| Assembly language (x86)                  | It's a low-level programming language that can directly communicate with the processor.                                                                                                                                      | [InfoSec Resources](https://resources.infosecinstitute.com/topics/secure-coding/what-is-x86-assembly/)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     |
| DOSBox emulator                          | It's a free and open-source emulator which runs software for MS-DOS compatible disk operating systems—primarily video games.                                                                                                 | [Wikipedia](https://en.wikipedia.org/wiki/DOSBox)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          |
| NASM (netwide assembler)                 | It's an assembler and disassembler for the Intel x86 architecture.                                                                                                                                                           | [Wikipedia](https://en.wikipedia.org/wiki/Netwide_Assembler)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               |
| IDE (integrated development environment) | It's a software application that provides comprehensive facilities for software development.                                                                                                                                 | [Wikipedia](https://en.wikipedia.org/wiki/Integrated_development_environment)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              |
| GitHub                                   | It's a code hosting platform for version control and collaboration.                                                                                                                                                          | [Github](https://docs.github.com/fr/get-started/quickstart/hello-world)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    |
...
| GitHub release                           | Releases are deployable software iterations you can package and make available for a wider audience to download and use.                                                                                                     | [Github](https://docs.github.com/en/repositories/releasing-projects-on-github/about-releases)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              |
</details>
